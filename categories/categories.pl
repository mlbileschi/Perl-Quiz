...
system("wget", "http://en.wikipedia.org/wiki/Category:Neuromuscular_diseases", "-O", "wikipedia_category_article.html", "-q");
open(INFILE, "<wikipedia_category_article.html") or die "couldn't open file wikipedia_category_article.html\n";
foreach(<INFILE>)
{
...
foreach (@articles_to_visit)
{
	...
	system("wget", $_, "-O", "wikipedia_category_article.html", "-q");
	open(INFILE, "<wikipedia_category_article.html") or die "couldn't open file wikipedia_category_article.html\n";

	my $parser = MyParser->new;				#new instance of this class ##changed this
   
	$parser->parse_file('wikipedia_category_article.html');
...
open(OUTFILE, ">neuromuscular_diseases.txt") or die "couldn't open category file";
