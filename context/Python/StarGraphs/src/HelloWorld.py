...
target = sys.argv[2] #the word that will be at the center of the star
...
for entry in sorted(context.items(),key=lambda e: e[1], reverse=True): 
		print(entry);
